        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              ...
              <form action="<?= site_url('admin/ImagesApotik/save') ?>" method="POST" enctype="multipart/form-data">
                <?= csrf_field() ?>
                ...
                <div class="row mb-3">
                  <div class="col-sm-10 offset-sm-2">
                    ...
                    <a href="<?= site_url('admin/ImagesApotik') ?>" class="btn btn-secondary">Cancel</a>
                  </div>
                </div>
              </form>
          ...
          <div class="card mt-4">
            <div class="card-body">
              <h5 class="card-title">Image List Apotik</h5>
              ...
              <table class="table datatable">
                ...
                <tbody>
                  <?php if (!empty($imagesap)): ?>
                    <?php foreach ($imagesap as $index => $image): ?>
                      <tr>
                        <td><?= $index + 1 ?></td>
                        <td><?= esc($image['nama']) ?></td>
                        <td><img src="<?= base_url('images/' . esc($image['image'])) ?>" alt="<?= esc($image['nama']) ?>" style="max-width: 100px;"></td>
                        <td>
                          <a href="<?= site_url('admin/ImagesApotik/edit/' . $image['id']) ?>" class="btn btn-warning btn-sm">Edit</a>
                          <a href="<?= site_url('admin/ImagesApotik/delete/' . $image['id']) ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this image?');">Delete</a>
                        </td>
                      </tr>
                    <?php endforeach; ?>
                  <?php else: ?>
