...
<head>
  ...
  <title>Tables / Data Gallery</title>
        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              ...
              <form action="<?= site_url('admin/ImagesGallery/save') ?>" method="POST" enctype="multipart/form-data">
                <?= csrf_field() ?>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="text" id="name" name="name" class="form-control" value="<?= isset($image) ? $image['name'] : '' ?>" required>
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  <div class="col-sm-10 offset-sm-2">
                    ...
                    <a href="<?= site_url('admin/ImagesGallery') ?>" class="btn btn-secondary">Cancel</a>
                  </div>
                </div>
              </form>
                ...
                <tbody>
                  <?php if (!empty($images)): ?>
                    <?php foreach ($images as $index => $image): ?>
                      <tr>
                        <td><?= $index + 1 ?></td>
                        <td><?= esc($image['name']) ?></td> <!-- Change to 'nama' if that's the correct column name -->
                        <td><img src="<?= base_url('images/' . $image['image']) ?>" style="max-width: 100px;"></td>
                        <td>
                          <a href="<?= site_url('admin/ImagesGallery/edit/' . $image['id']) ?>" class="btn btn-warning btn-sm">Edit</a>
                          <a href="<?= site_url('admin/ImagesGallery/delete/' . $image['id']) ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this image?');">Delete</a>
                        </td>
                      </tr>
                    <?php endforeach; ?>
                  <?php else: ?>
