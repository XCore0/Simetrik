        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              ...
              <form action="<?= site_url('admin/ImagesTestimoni/save') ?>" method="POST" enctype="multipart/form-data">
                <?= csrf_field() ?>
                ...
                <?php if (isset($image)): ?>
                  <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                      <img src="<?= base_url('images/' . esc($image['image'])) ?>" style="max-width: 200px; display: block;">
                    </div>
                  </div>
                <?php endif; ?>
                ...
                <div class="row mb-3">
                  <div class="col-sm-10 offset-sm-2">
                    ...
                    <a href="<?= site_url('/admin/ImagesTestimoni') ?>" class="btn btn-secondary">Cancel</a>
                  </div>
                </div>
              </form>
          ...
          <div class="card mt-4">
            <div class="card-body">
              <h5 class="card-title">Image Testimoni</h5>
              ...
              <table class="table datatable">
                ...
                <tbody>
                  <?php if (!empty($imagestes)): ?>
                    <?php foreach ($imagestes as $index => $image): ?>
                      <tr>
                        <td><?= $index + 1 ?></td>
                        <td><?= esc($image['nama']) ?></td>
                        <td><img src="<?= base_url('images/' . esc($image['image'])) ?>" style="max-width: 100px;"></td>
                        <td>
                          <a href="<?= site_url('admin/ImagesTestimoni/edit/' . $image['id']) ?>" class="btn btn-warning btn-sm">Edit</a>
                          <a href="<?= site_url('admin/ImagesTestimoni/delete/' . $image['id']) ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this image?');">Delete</a>
                        </td>
                      </tr>
                    <?php endforeach; ?>
                  <?php else: ?>
