        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              ...
              <form action="<?= site_url('admin/ImagesAcara/save') ?>" method="POST" enctype="multipart/form-data">
                <?= csrf_field() ?>
                ...
                <div class="row mb-3">
                  <div class="col-sm-10 offset-sm-2">
                    ...
                    <a href="<?= site_url('admin/ImagesAcara') ?>" class="btn btn-secondary">Cancel</a>
                  </div>
                </div>
              </form>
                  ...
                  <?php if (!empty($imagesacara)): ?>
                    <?php foreach ($imagesacara as $index => $image): ?>
                      <tr>
                        ...
                        <td>
                          <a href="<?= site_url('admin/ImagesAcara/edit/' . $image['id']) ?>" class="btn btn-warning btn-sm">Edit</a>
                          <a href="<?= site_url('admin/ImagesAcara/delete/' . $image['id']) ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this image?');">Delete</a>
                        </td>
                      </tr>
                    <?php endforeach; ?>
                  <?php else: ?>
