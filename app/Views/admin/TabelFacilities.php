...
<head>
  ...
  <title>Tables / Data Faciliti</title>
...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link active" href="<?= site_url('/admin/tabel-facilities') ?>">
          <i class="bi bi-grid"></i>
              ...
              <table class="table datatable">
                ...
                <tbody>
                  ...
                  <?php foreach ($facilities as $facility): ?>
                    <tr>
                      <td><?php echo $i++; ?></td>
                      <td><?php echo esc($facility['health_facility_name']); ?></td>
                      <td><?php echo esc($facility['name']); ?></td>
                      <td><?php echo esc($facility['whatsapp']); ?></td>
                      <td><?php echo esc($facility['email']); ?></td>
                      <td><?php echo esc($facility['city']); ?></td>
                      <td><?php echo esc($facility['product_variant']); ?></td>
                      <td>
                        <span
                          class="status-toggle"
                          data-id="<?php echo $facility['id']; ?>"
                          data-status="<?php echo esc($facility['status']); ?>"
                          style="cursor: pointer; color: <?php echo $facility['status'] == 'checked' ? 'green' : 'red'; ?>;">
                          <?php echo $facility['status'] == 'checked' ? '✔️' : '❌'; ?>
                        </span>
                      </td>
                    </tr>
                  <?php endforeach; ?>
